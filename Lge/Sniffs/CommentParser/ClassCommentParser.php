 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Lge_Sniffs_CommentParser_ClassCommentParser extends Lge_Sniffs_CommentParser_AbstractParser
{
    ...
    {
        $this->_license = new Lge_Sniffs_CommentParser_PairElement(
    ...
    {
        $copyright = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'copyright',
            $this->phpcsFile
    ...
    {
        $this->_category = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'category',
            $this->phpcsFile
     ...
     * @param array $tokens The tokens that comprise this tag.
     *
     * @return array(Lge_Sniffs_CommentParser_SingleElement)
     */
    protected function parseAuthor($tokens)
    {
        $author = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'author',
            $this->phpcsFile
    ...
    {
        $this->_version = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'version',
            $this->phpcsFile
    ...
    {
        $this->_package = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'package',
            $this->phpcsFile
    ...
    {
        $this->_subpackage = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'subpackage',
            $this->phpcsFile
