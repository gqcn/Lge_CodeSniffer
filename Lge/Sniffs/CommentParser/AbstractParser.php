...
if (class_exists('Lge_Sniffs_CommentParser_CommentElement', true) === false) {
    $error = 'Class Lge_Sniffs_CommentParser_CommentElement not found';
    throw new PHP_CodeSniffer_Exception($error);
}

if (class_exists('Lge_Sniffs_CommentParser_ParserException', true) === false) {
    $error = 'Class Lge_Sniffs_CommentParser_ParserException not found';
    throw new PHP_CodeSniffer_Exception($error);
}
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
abstract class Lge_Sniffs_CommentParser_AbstractParser
{

    /**
     * The comment element that appears in the doc comment.
     *
     * @var Lge_Sniffs_CommentParser_CommentElement
     */
     ...
     * doc comment.
     *
     * @var Lge_Sniffs_CommentParser_DocElement
     */
     ...
     *
     * @var array(Lge_Sniffs_CommentParser_SingleElement)
     */
     ...
     *
     * @return void
     * @throws Lge_Sniffs_CommentParser_ParserException If the parser finds a
     *                                                       problem with the
     *                                                       comment.
     */
     ...
     * @return void
     * @see _parse()
     * @throws Lge_Sniffs_CommentParser_ParserException If more than the allowed
    ...
    {
        $see = new Lge_Sniffs_CommentParser_SingleElement(
    ...
    {
        $this->comment = new Lge_Sniffs_CommentParser_CommentElement(
            $this->previousElement,
            $tokens,
            $this->phpcsFile
        );
    ...
    {
        $this->deprecated = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'deprecated',
            $this->phpcsFile
    ...
    {
        $this->since = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'since',
            $this->phpcsFile
    ...
    {
        $link = new Lge_Sniffs_CommentParser_SingleElement(
            $this->previousElement,
            $tokens,
            'link',
            $this->phpcsFile
    ...
    protected function parseTag($tag, $start, $end)
    {
        ...
        if ($tag === 'comment' || in_array($tag, $allowedTagNames) === true) {
            ...
            $this->previousElement = new Lge_Sniffs_CommentParser_SingleElement(
                $this->previousElement,
                $tokens,
                $tag,
                $this->phpcsFile
        ...
        if ($this->previousElement === null
            || ($this->previousElement instanceof Lge_Sniffs_CommentParser_DocElement) === false
        ) {
