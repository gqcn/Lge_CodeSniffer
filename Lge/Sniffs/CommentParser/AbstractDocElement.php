...
if (interface_exists('Lge_Sniffs_CommentParser_DocElement', true) === false) {
    $error = 'Interface Lge_Sniffs_CommentParser_DocElement not found';
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
abstract class Lge_Sniffs_CommentParser_AbstractDocElement implements Lge_Sniffs_CommentParser_DocElement
{
    ...
    public function __construct(
        ...
        if ($previousElement !== null
            && ($previousElement instanceof Lge_Sniffs_CommentParser_DocElement) === false
        ) {
     ...
     *
     * @return Lge_Sniffs_CommentParser_DocElement
     */
