...
if (class_exists('Lge_Sniffs_CommentParser_AbstractDocElement', true) === false) {
    $error = 'Class Lge_Sniffs_CommentParser_AbstractDocElement not found';
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Lge_Sniffs_CommentParser_ParameterElement extends Lge_Sniffs_CommentParser_AbstractDocElement
{
    ...
    /**
     * Constructs a Lge_Sniffs_CommentParser_ParameterElement.
     *
     * @param Lge_Sniffs_CommentParser_DocElement $previousElement The element
     *                                                                  previous to
     *                                                                  this one.
    ...
    {
        if (($this->getPreviousElement() instanceof Lge_Sniffs_CommentParser_ParameterElement) === false) {
            return 1;
        } else {
     ...
     *
     * @param Lge_Sniffs_CommentParser_ParameterElement $other The other param
     *                                                              to check
     *                                                              alignment with.
     *
     * @return boolean
    ...
    public function alignsVariableWith(
        Lge_Sniffs_CommentParser_ParameterElement $other
    ) {
        // Format is:
     ...
     * @return boolean
     */
    public function alignsWith(Lge_Sniffs_CommentParser_ParameterElement $other)
    {
